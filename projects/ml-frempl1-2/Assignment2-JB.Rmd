...
plotdf <- data.frame(truth = exp(regr_data_test$truth),
                     prediction = exp(predict(xgb_regr_train, newdata = regr_data_test$covariates)))
...
| :-: | :-: | :-: | :-: | :-: | :-: |
| 6257 | `r round(df$Exposure[df$ID == 6257],2)` | `r round(df$mu_hat[df$ID == 6257],2)` | `r round(df$p_hat[df$ID == 6257],5)` | `r round(df$pi_hat[df$ID == 6257],2)` | 
| 24131 | `r round(df$Exposure[df$ID == 24131],2)` | `r round(df$mu_hat[df$ID == 24131],2)` | `r round(df$p_hat[df$ID == 24131],5)` | `r round(df$pi_hat[df$ID == 24131],2)` | 
| 25018 | `r round(df$Exposure[df$ID == 25018],2)` | `r round(df$mu_hat[df$ID == 25018],2)` | `r round(df$p_hat[df$ID == 25018],5)` | `r round(df$pi_hat[df$ID == 25018],2)` | 
| 25196 | `r round(df$Exposure[df$ID == 25196],2)` | `r round(df$mu_hat[df$ID == 25196],2)` | `r round(df$p_hat[df$ID == 25196],5)` | `r round(df$pi_hat[df$ID == 25196],2)` | 
| 30503 | `r round(df$Exposure[df$ID == 30503],2)` | `r round(df$mu_hat[df$ID == 30503],2)` | `r round(df$p_hat[df$ID == 30503],5)` | `r round(df$pi_hat[df$ID == 30503],2)` | 
| 30563 | `r round(df$Exposure[df$ID == 30563],2)` | `r round(df$mu_hat[df$ID == 30563],2)` | `r round(df$p_hat[df$ID == 30563],5)` | `r round(df$pi_hat[df$ID == 30563],2)` |

If we set the exposure to one we get new estimates and the technical price the insurance firm will give to new contracts.

| Policy | Exposure | $\hat \mu_X$ | $\hat p_X$ | $\hat \pi$ |
| :-: | :-: | :-: | :-: | :-: | :-: |
| 6257 | 1 | `r round(m_mu_ranger[df$ID == 6257],2)` | `r round(m_p_ranger_2[df$ID == 6257],5)` | `r round(df$pi_hat_new[df$ID == 6257],2)` | 
| 24131 | 1 | `r round(m_mu_ranger[df$ID == 24131],2)` | `r round(m_p_ranger_2[df$ID == 24131],5)` | `r round(df$pi_hat_new[df$ID == 24131],2)` | 
| 25018 | 1 | `r round(m_mu_ranger[df$ID == 25018],2)` | `r round(m_p_ranger_2[df$ID == 25018],5)` | `r round(df$pi_hat_new[df$ID == 25018],2)` | 
| 25196 | 1 | `r round(m_mu_ranger[df$ID == 25196],2)` | `r round(m_p_ranger_2[df$ID == 25196],5)` | `r round(df$pi_hat_new[df$ID == 25196],2)` | 
| 30503 | 1 | `r round(m_mu_ranger[df$ID == 30503],2)` | `r round(m_p_ranger_2[df$ID == 30503],5)` | `r round(df$pi_hat_new[df$ID == 30503],2)` | 
| 30563 | 1 | `r round(m_mu_ranger[df$ID == 30563],2)` | `r round(m_p_ranger_2[df$ID == 30563],5)` | `r round(df$pi_hat_new[df$ID == 30563],2)` | 
...
| `nrounds` | $[75,5000]$ | `r sev_xgb_learner_instance$result_learner_param_vals$nrounds` |
...
| `nrounds` | $[75,5000]$ | `r freq_xgb_learner_instance$result_learner_param_vals$nrounds` |
