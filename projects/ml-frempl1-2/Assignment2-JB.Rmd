...
although this might be a bit excessive in the name of separating the estimates. We apply this debiassing algorithm and estimate a unbiased price model for the policies 6254,24123,25010,25188,30495 and 30555.
...
As it can be read in the table how the premiums change with up to 15 percent (plus or minus). It can furthermore be seen in the figure above how the biased premiums are shifted. We included model estimates from a model that is fitted without any use of the gender feature.
