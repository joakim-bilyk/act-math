...
indicators <- colnames(df_sev)[!(colnames(df_sev) %in% c("LicAge","BonusMalus","DrivAge","ClaimAmount","Exposure","ClaimInd"))]
...
policies_sev_gam <- sev_gam_tuned_regr$predict_newdata(df[freMPL1$id %in% policies,])
options(scipen = 999)
library(kableExtra)
kbl(freMPL1[freMPL1$id %in% policies,],caption = "Policy covariates for policies of interest (6257, 24131, 25018, 25196, 30503 and 30563).", format="latex", booktabs=TRUE) %>% 
...
```{r,echo=FALSE}
policies_sev_glmnet <- sev_glmnet_tuned_regr$predict_newdata(df[freMPL1$id %in% policies,])
```
...
```{r,echo=FALSE}
policies_sev_xgb <- sev_xgb_tuned_regr$predict_newdata(df[freMPL1$id %in% policies,])
```
...
```{r,echo=FALSE}
policies_sev_bart <- sev_bart_tuned_regr$predict_newdata(df[freMPL1$id %in% policies,])
```
...
```{r,echo=FALSE}
policies_sev_ranger <- sev_ranger_tuned_regr$predict_newdata(df[freMPL1$id %in% policies,])
```
...
freq_gam_tuned <- lrn("classif.gam",
                      predict_type = "prob")
indicators <- colnames(df)[!(colnames(df) %in% c("LicAge","BonusMalus","DrivAge","id","ClaimAmount","ClaimInd"))]
...
```{r,echo=FALSE}
policies_freq_gam <- freq_gam_tuned$predict_newdata(df_freq[freMPL1$id %in% policies,])
```
...
```{r,echo=FALSE}
policies_freq_glmnet <- freq_glmnet_tuned$predict_newdata(df_freq[freMPL1$id %in% policies,])
```
...
```{r,echo=FALSE}
policies_freq_xgb <- freq_xgb_tuned$predict_newdata(df_freq[freMPL1$id %in% policies,])
```
...
```{r,echo=FALSE}
policies_freq_bart <- freq_bart_tuned$predict_newdata(df_freq[freMPL1$id %in% policies,])
```
...
```{r,echo=FALSE}
policies_ranger_glmnet <- freq_ranger_tuned$predict_newdata(df_freq[freMPL1$id %in% policies,])
```
...
| :-: | :-: | :-: | :-: | :-: | :-: |
| 6257 | `r round(freMPL1$Exposure[freMPL1$id == 6257],2)` | `r round(freMPL1$mu_hat[freMPL1$id == 6257],2)` | `r round(freMPL1$p_hat[freMPL1$id == 6257],5)` | `r round(freMPL1$pi_hat[freMPL1$id == 6257],2)` | 
| 24131 | `r round(freMPL1$Exposure[freMPL1$id == 24131],2)` | `r round(freMPL1$mu_hat[freMPL1$id == 24131],2)` | `r round(freMPL1$p_hat[freMPL1$id == 24131],5)` | `r round(freMPL1$pi_hat[freMPL1$id == 24131],2)` | 
| 25018 | `r round(freMPL1$Exposure[freMPL1$id == 25018],2)` | `r round(freMPL1$mu_hat[freMPL1$id == 25018],2)` | `r round(freMPL1$p_hat[freMPL1$id == 25018],5)` | `r round(freMPL1$pi_hat[freMPL1$id == 25018],2)` | 
| 25196 | `r round(freMPL1$Exposure[freMPL1$id == 25196],2)` | `r round(freMPL1$mu_hat[freMPL1$id == 25196],2)` | `r round(freMPL1$p_hat[freMPL1$id == 25196],5)` | `r round(freMPL1$pi_hat[freMPL1$id == 25196],2)` | 
| 30503 | `r round(freMPL1$Exposure[freMPL1$id == 30503],2)` | `r round(freMPL1$mu_hat[freMPL1$id == 30503],2)` | `r round(freMPL1$p_hat[freMPL1$id == 30503],5)` | `r round(freMPL1$pi_hat[freMPL1$id == 30503],2)` | 
| 30563 | `r round(freMPL1$Exposure[freMPL1$id == 30563],2)` | `r round(freMPL1$mu_hat[freMPL1$id == 30563],2)` | `r round(freMPL1$p_hat[freMPL1$id == 30563],5)` | `r round(freMPL1$pi_hat[freMPL1$id == 30563],2)` |

If we set the exposure to one we get new estimates and the technical price the insurance firm will give to new contracts.

| Policy | Exposure | $\hat \mu_X$ | $\hat p_X$ | $\hat \pi$ |
| :-: | :-: | :-: | :-: | :-: | :-: |
| 6257 | 1 | `r round(m_mu_ranger_2[freMPL1$id == 6257],2)` | `r round(m_p_ranger_2[freMPL1$id == 6257],5)` | `r round(freMPL1$pi_hat_new[freMPL1$id == 6257],2)` | 
| 24131 | 1 | `r round(m_mu_ranger_2[freMPL1$id == 24131],2)` | `r round(m_p_ranger_2[freMPL1$id == 24131],5)` | `r round(freMPL1$pi_hat_new[freMPL1$id == 24131],2)` | 
| 25018 | 1 | `r round(m_mu_ranger_2[freMPL1$id == 25018],2)` | `r round(m_p_ranger_2[freMPL1$id == 25018],5)` | `r round(freMPL1$pi_hat_new[freMPL1$id == 25018],2)` | 
| 25196 | 1 | `r round(m_mu_ranger_2[freMPL1$id == 25196],2)` | `r round(m_p_ranger_2[freMPL1$id == 25196],5)` | `r round(freMPL1$pi_hat_new[freMPL1$id == 25196],2)` | 
| 30503 | 1 | `r round(m_mu_ranger_2[freMPL1$id == 30503],2)` | `r round(m_p_ranger_2[freMPL1$id == 30503],5)` | `r round(freMPL1$pi_hat_new[freMPL1$id == 30503],2)` | 
| 30563 | 1 | `r round(m_mu_ranger_2[freMPL1$id == 30563],2)` | `r round(m_p_ranger_2[freMPL1$id == 30563],5)` | `r round(freMPL1$pi_hat_new[freMPL1$id == 30563],2)` | 
